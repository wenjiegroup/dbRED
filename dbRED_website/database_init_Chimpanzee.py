...
django.setup()
from RnaSearch.models import Chimpanzee_Rnaedit
path = '/home/zhaochenghui/Rnaedit/'

def average(seq):
    return float(sum(seq)) / len(seq)

def main():
    f = open(path+'Chimpanzee_result_update_cellType','r')
    ...
    for i in f.readlines():
        ...
        Chimpanzee_Rnaedit.objects.create(name=name, Chr = lis[0], position = int(lis[1]),\
