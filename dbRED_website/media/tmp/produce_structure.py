...
os.system('java -cp VARNAv3-93.jar fr.orsay.lri.varna.applications.VARNAcmd -i '+specie+'_'+chr+'_'+pos+'_ref_ss -o '+path+specie+'_'+chr+'_'+pos+'_ref.png -algorithm naview -annotations "AtoI:anchor=101,size=50,color=#ff000,type=B" -resolution "4.0" -highlightRegion "101-101:outline=#ff0000" -baseInner "#334455"')
...
os.system('java -cp VARNAv3-93.jar fr.orsay.lri.varna.applications.VARNAcmd -i '+specie+'_'+chr+'_'+pos+'_alt_ss -o '+path+specie+'_'+chr+'_'+pos+'_alt.png -algorithm naview -annotations "AtoI:anchor=101,size=50,color=#ff000,type=B" -resolution "4.0" -highlightRegion "101-101:outline=#ff0000" -baseInner "#334455"')
