...
django.setup()
from RnaSearch.models import Dmojavensis_Rnaedit
...
def main():
    f = open(path+'D.mojavensis_result','r')
    ...
    for i in f.readlines():
        ...
        Dmojavensis_Rnaedit.objects.create(name=name, Chr = lis[0], position = int(lis[1]),\
