...
django.setup()
from RnaSearch.models import Dpseudoobscura_Rnaedit
...
def main():
    f = open(path+'D.pseudoobscura_result','r')
    ...
    for i in f.readlines():
        ...
        Dpseudoobscura_Rnaedit.objects.create(name=name, Chr = lis[0], position = int(lis[1]),\
        ...
        Sequence = lis[12], Cellline = lis[13])
