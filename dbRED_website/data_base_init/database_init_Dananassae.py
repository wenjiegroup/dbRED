...
django.setup()
from RnaSearch.models import Dananassae_Rnaedit
...
def main():
    f = open(path+'D.ananassae_result','r')
    ...
    for i in f.readlines():
        ...
        Dananassae_Rnaedit.objects.create(name=name, Chr = lis[0], position = int(lis[1]),\
