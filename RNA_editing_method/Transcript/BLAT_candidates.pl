...
while (<$INPUT>) {
	...
	system("/public2/home/zhaoch/local/samtools-1.3.1/samtools view $bamfile $bamposition > $TEMPNAME"); #get reads overlapping candidate site
	my $editnuc = $fields[4];
	my $newmismatch = 0;
...
system("/public2/home/zhaoch/RNA_editing_script_for_Zhaochenghui/RNA_editing_method/Transcript/blat -stepSize=20 -repMatch=2253 -minScore=20 -minIdentity=0 -noHead $Reference $fafile $pslfile");
system("rm $fafile");
