...
my $bam = $ARGV[1];
my $outfile = $ARGV[2];
my $process = $ARGV[3];#最多$process个线程

my $PerlScript = "/public2/home/zhaoch/RNA_editing_script_for_Zhaochenghui/RNA_editing_method/Transcript/Remove_mismatch_first6bp.pl";
