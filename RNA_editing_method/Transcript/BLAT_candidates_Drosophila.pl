...
while (<$INPUT>) {
	...
	system("/home/lihao/bin/software/samtools_0.1.18 view $bamfile $bamposition > $TEMPNAME"); #get reads overlapping candidate site
	my $editnuc = $fields[4];
	my $newmismatch = 0;
...
system("/home/lihao/bin/RNA_editing_method/Transcript/blat -stepSize=20 -repMatch=2253 -minScore=20 -minIdentity=0 -noHead /home/lihao/bin/Genome_Index/BWA_dm3/dm3.fa $fafile $pslfile");
#system("./software/blat -noHead /home/lihao/bin/BWA_hg19/ucsc.hg19.fasta $fafile $pslfile");
system("rm $fafile");
